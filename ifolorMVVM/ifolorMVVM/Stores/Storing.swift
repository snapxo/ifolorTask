...
extension StoringConfiguration where T == RegistrationViewModel {
    static let registeredUser = Self.init(key: .registeredUser, fallbackValue: RegistrationViewModel())
}
